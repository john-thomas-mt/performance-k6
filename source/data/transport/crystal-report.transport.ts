...
/* Generated by scripts/gen-fidelity-lists.js from the crystal-report NeoLoad tree — do not hand-edit.
...
export const crystalReportTransport: { [step: string]: ChromeRequest[][] } = {
  '11': [
    [
      {
        method: 'POST',
