...
Both runs passed: **100% checks, 0% request failures**, well under all latency thresholds. The system under test behaved the same regardless of agent; the Momentus agent's app-side latency was marginally _lower_ (within run-to-run noise).
