...
- A payload-building transform shared by more than one `source/data/` builder is promoted here (e.g. `today_midnight_utc`, the shared date-window helper) rather than duplicated in a module-local `data/payloads/<module>/helpers.ts`.
